      ...
      <div className="relative max-w-3xl w-full p-6 bg-white rounded-lg shadow-lg overflow-y-auto max-h-screen">
        ...
        <div className="mb-4">
          ...
          <select
            ...
            onChange={(e) => {
              ...
              // For FEEDS and RICE loans update maxSacks based on share capital.
        ...
        {(loanType === "feeds" || loanType === "rice") && (
          <>
            ...
            {/* Auto-generated Terms for FEEDS & RICE Loans */}
            <div className="mb-4">
            ...
            <div className="mb-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <input
                  ...
                  onChange={(e) => setHousingCoMaker({ ...motercycleComaker, name: e.target.value })}
                />
                <input
                  type="text"
                  className="w-full p-2 border rounded-lg"
                  ...
                  onChange={(e) => setHousingCoMaker({ ...motercycleComaker, memberId: e.target.value })}
                />
              </div>
            </div>
            <div className="mb-4">
              ...
              <div className="grid grid-cols-1 gap-4">
                <input
                  ...
                  onChange={(e) => setHousingCoBorrower({ ...motercycleCoBorrower, memberId: e.target.value })}
                />
                <input
                  type="text"
                  className="w-full p-2 border rounded-lg"
                  ...
                  onChange={(e) => setHousingCoBorrower({ ...motercycleCoBorrower, relationship: e.target.value })}
                />
                <input
                  type="text"
                  className="w-full p-2 border rounded-lg"
                  ...
                  onChange={(e) => setHousingCoBorrower({ ...motercycleCoBorrower, name: e.target.value })}
                />
                <input
                  type="text"
                  className="w-full p-2 border rounded-lg"
                  ...
                  onChange={(e) => setHousingCoBorrower({ ...motercycleCoBorrower, contactNumber: e.target.value })}
                />
                <input
                  type="text"
                  className="w-full p-2 border rounded-lg"
                  ...
                  onChange={(e) => setHousingCoBorrower({ ...motercycleCoBorrower, address: e.target.value })}
                />
              </div>
            </div>
            <div className="mb-4">
