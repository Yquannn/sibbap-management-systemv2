...
const LoanDetails = () => {
  ...
  return (
    <div className="max-w-lg mx-auto relative">
      {/* Header */}
      <div className="flex items-center justify-center p-4 bg-white shadow-md relative">
        <button
      ...
      <div className="p-4 mt-4">
        ...
        <div className="bg-gray-100 p-5 rounded-lg">
          <div className="grid grid-cols-2 gap-y-2 text-gray-700 text-sm">
            ...
            <span className="text-right text-green-600 font-semibold">₱1.75</span>
            <span className="font-medium">Loan Amount:</span>
            <span className="text-right text-green-600 font-semibold">₱0</span>
            <span className="font-medium">Monthly Amortization:</span>
            <span className="text-right text-green-600 font-semibold">₱450</span>
            <span className="font-medium">Terms:</span>
            <span className="text-right">1</span>
            <span className="font-medium">Date Release:</span>
            <span className="text-right font-semibold text-gray-800">N/A</span>
            <span className="font-medium">Service Fee (3%):</span>
            <span className="text-right text-green-600 font-semibold">₱150</span>
            <span className="font-medium">Additional Savings (1%):</span>
            <span className="text-right text-green-600 font-semibold">₱50</span>
            <span className="font-medium">Capital Buildup (1%):</span>
            <span className="text-right text-green-600 font-semibold">₱50</span>
            <span className="font-medium">Gift Check:</span>
            <span className="text-right text-green-600 font-semibold">₱30</span>
            <span className="font-medium">Insurance:</span>
            <span className="text-right text-green-600 font-semibold">₱70</span>
            <span className="font-medium">Others/Receivables:</span>
            <span className="text-right text-green-600 font-semibold">₱40</span>
          </div>
          <hr className="my-3 border-gray-300" />
          <div className="flex justify-between font-semibold text-lg text-gray-900">
            <span>Total Disbursed:</span>
            <span className="text-green-700">₱4,460</span>
          </div>
        </div>
