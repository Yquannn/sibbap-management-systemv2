      ...
      <div className="bg-white p-6 rounded-2xl shadow-lg w-full max-w-7xl">
        ...
        <div className="mt-4">
          <p className="text-gray-700">
            <strong>Borrower:</strong> <span className="text-xl font-bold text-gray-500">{borrower.last_name}, {borrower.first_name} {borrower.middle_name}</span>
          </p>
          <p className="text-gray-700">
            <strong>Loan Type:</strong> {borrower.loan_type}
          </p>
        </div>
              ...
              <tbody>
                {[...Array(15)].map((_, index) => (
                  <tr key={index} className="hover:bg-gray-100 transition">
                    ...
                    <td className="border p-2">Settled</td>
                    <td className="border p-2 text-center ">
                      <button className="bg-green-500 text-white px-8 py-1 rounded hover:bg-green-600">
                        Pay
                      </button>
                    </td>
                  </tr>
