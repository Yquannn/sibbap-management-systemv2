...
// import { FaCog, FaQuestionCircle, FaBell, FaTimes, FaCircle, FaCheck, FaRegBell, FaChevronLeft } from 'react-icons/fa';
// import axios from 'axios';
// import { useNavigate } from 'react-router-dom';
// import ProfileComponent from './UserProfile'; // Import the new profile component
...
//     const now = new Date();
//     const past = new Date(dateString);s
...
//           className="flex items-center p-2 text-gray-500 hover:text-gray-800 hover:bg-gray-100 rounded-lg transition-colors"
//         >
