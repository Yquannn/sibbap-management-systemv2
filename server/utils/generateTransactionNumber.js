 function generateTransactionNumber() {
  ...
  function generateRolloverTransactionNumber() {
    const timestamp = Date.now();
    const randomPart = Math.floor(1000 + Math.random() * 9000);
    return `RTXN-${timestamp}-${randomPart}`;
  }
  ...
  module.exports = { generateTransactionNumber, generateAccountNumber, generateRolloverTransactionNumber };
